...
dhdsdio_readconsole(dhd_bus_t *bus)
{
	...
	while (c->last != idx) {
		...
		/** ZTE_MODIFY longchunyan0003 repaired by longchunyan 2011/09/21 for fixing coredump caused by printk manytimes*/
   if (printk_ratelimit())
		{
		    printf("CONSOLE: %s\n", line);
		}
	...
	uint16 func, uint bustype, void *regsva, osl_t * osh, void *sdh)
{
    ...
    /** ZTE_MODIFY longchunyan0002 added for detecting wifi by longchunyan 2011/07/22*/
    printk("WIFI SUCCESS\n");
    /** ZTE_MODIFY end*/
	return bus;
