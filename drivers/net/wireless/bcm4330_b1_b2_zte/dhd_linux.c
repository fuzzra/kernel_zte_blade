...
_dhd_sysioc_thread(void *data)
{
	...
	while (down_interruptible(&tsk->sema) == 0) {
       ...
       /** ZTE_MODIFY longchunyan0003 repaired for wifi sleeping by longchunyan 2011/09/30*/
       DHD_OS_WAKE_LOCK(&dhd->pub);   
       /** ZTE_MODIFY longchunyan0003 end*/
...
dhd_attach(osl_t *osh, struct dhd_bus *bus, uint bus_hdrlen)
{
	...
	/** ZTE_MODIFY longchunyan0002 repaired for firmware & nvram path by longchunyan 2011/07/22*/
	#if 0
...
dhd_dev_reset(struct net_device *dev, uint8 flag)
{
    ...
    /** ZTE_MODIFY longchunyan0002 repaired for soft ap by longchunyan 2011/07/22*/
	#if 0
    return 1;
	#else
    if (ret) 
...
int dhd_os_wake_lock(dhd_pub_t *pub)
{
	...
	if (dhd) {
		...
		if (!dhd->wakelock_counter)
		{
            ...
            /** ZTE_MODIFY longchunyan0003 added for wifi sleeping by longchunyan 2011/09/30*/
